              ...
              (let* ((out #$output)
                ...
                (call-with-output-file launcher
                  (lambda (port)
                    ...
                    (display "  if ! { \"$sleep\" 1; printf 'y'; \"$sleep\" 1; printf ' '; \"$sleep\" 1; printf ' '; \"$sleep\" 1; printf ' '; \"$sleep\" 1; printf ' '; \"$sleep\" 1; printf 'y'; \"$sleep\" 1; printf 'q'; \"$sleep\" 1; printf 'y'; } | \"$script\" -qefc \"$real -X -n -u goocastle-tourist-human-neutral-male\" \"$second_log\"; then\n"
                             port)
