              ...
              (let* ((out #$output)
                ...
                (call-with-output-file runner
                  (lambda (port)
                    ...
                    (display "            and all(word in stage_lower\n" port)
                    ...
                    (display "            and b'new game' in stage_lower\n" port)
                    (display "            and b'quit' in stage_lower):\n" port)
                    (display "        os.write(master, b'Q')\n" port)
