...
`axmud`, `frostbite`, `kildclient`, `kmuddy`, `mmapper`, `mudlet`, `mushkin`, `mushtato`,
...
| `mudlet` | `Mudlet/Mudlet` | Qt6 graphical MUD client with Lua scripting, mapping, multimedia, MXP, and GMCP |
